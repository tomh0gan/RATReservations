					...
					<div class = "well">
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								...
								String seatNumQuery = "SELECT seatNum FROM reservation_legs WHERE airlineId='"+legs.get(j).getL().getAirlineId()+"' AND flightNum="+legs.get(j).getL().getFlightNum()+" AND legNum="+legs.get(j).getL().getLegNum()+" AND depDate='"+legs.get(j).getL().getDepDate()+"';";
